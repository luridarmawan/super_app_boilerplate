...
//
// Usage:
//   dart run tool/generate_module_internal.dart [module_name]
//
// Example:
...
void main(List<String> args) {
  print('');
  print('╔══════════════════════════════════════════╗');
  print('║    INTERNAL MODULE GENERATOR CLI TOOL    ║');
  print('╚══════════════════════════════════════════╝');
  print('');
  ...
  if (args.isEmpty) {
    ...
    print('');
    print('Usage: dart run tool/generate_module_internal.dart <module_name>');
    print('');
    print('Example:');
    print('  dart run tool/generate_module_internal.dart news');
    print('  dart run tool/generate_module_internal.dart ecommerce');
    exit(1);
  }
